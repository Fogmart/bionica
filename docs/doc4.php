...
<h1 id="reader-title">Политика конфиденциальности</h1>
...
<ol>
<li>Срок обработки персональных данных Пользователя ничем не ограничен. Процедура обработки может проводиться любым предусмотренным законодательством способом. В частности, с помощью информационныхсистем&nbsp;персональных данных, которые могут вестись автоматически либо без средств автоматизации.</li>
...
<li>Все предложения, пожелания, требования или вопросы по настоящей Политике конфиденциальности следует сообщать в раздел обратной связи, расположенный по адресу: <strong><a href="https://bionika-market.com/company.php">bionika-market.com</a></strong>. Или путем отправки электронного письма по адресу <a href="mailto:bionika-market@mail.ru"></strong><strong>bionika</strong><strong>-</strong><strong>market</strong><strong>@</strong><strong>mail</strong><strong>.</strong><strong>ru</strong></a></li>
<li>Прочитать о существующей Политике конфиденциальности можно, зайдя на страницу <a href="https://bionika-market.com">bionika-market.com</a></li>
</ol>
</li>
</ol>
</li>
