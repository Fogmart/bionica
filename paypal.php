...
<form method="post" id="go" action= "https://www.paypal.com/cgi-bin/webscr"> <!--https://www.sandbox.paypal.com/cgi-bin/webscr-->
...
<input type="hidden" name="amount" value="<?echo number_format($sum_all, 2, '.','');?>"> <!--100-->
